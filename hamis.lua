        ...
        if(pressed_frame ~= nil)then
            ...
            if(GameGetFrameNum() - pressed_frame > 50)then
                ...
                if(not HasFlagPersistent("super_secret_hamis_mode"))then
                    ...
                    GamePrint("Super Secret Hämis Mode Already Unlocked! (Hämis appreciates the pets tho)")
                    GamePrintImportant("SUPER SECRET HÄMIS MODE ALREADY UNLOCKED!", "Hämis appreciates the pets tho")
                end
