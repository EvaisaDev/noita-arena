...
"noita_dev.exe" -splice_pixel_scene mods/evaisa.arena/files/biome/pixelscenes/holymountain/temple.png -x "-174" -y "-133" -debug 1

REM Run the second command to generate the temple_itemshop files and folders
"noita_dev.exe" -splice_pixel_scene mods/evaisa.arena/files/biome/pixelscenes/holymountain/temple_itemshop.png -x "-174" -y "-133" -debug 1
